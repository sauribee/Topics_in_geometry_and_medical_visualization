...
\title[Curvas de Bézier y B-splines en Modelado Médico]{Modelado Geométrico con Curvas de Bézier y B-splines \\
\small{Aplicación a Contornos de Cráneo}}
\author{Santiago Uribe \texorpdfstring{\\}{, } Tópicos en Geometría y Visualización Médica \thanks{Universidad Nacional de Colombia, Sede Medell{\'i}n}}
...
\begin{frame}
	\frametitle{Parametriz  ación de curvas}
