...
def generate_clean_bspline(
    ...
    filename = (
        f"rotator_cuff_simple_degree{degree}_{method_tag}{smooth_tag}_{timestamp}.png"
    )
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Simple B-Spline for Medical Image Contours"
    )
    parser.add_argument(
        "--points_file",
        default="ptos.mat",
    ...
    parser.add_argument(
        "--degree", type=int, default=3, help="B-spline degree (3=cubic, 2=quadratic)"
    )
    parser.add_argument(
        "--smoothing",
        type=float,
