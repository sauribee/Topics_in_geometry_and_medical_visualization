...
def compare_methods(
    ...
    if show_plot or save_plot:
        fig, axes = plt.subplots(
            2 if show_derivatives else 1, 1, figsize=(12, 10 if show_derivatives else 6)
        )
        ...
        if eval_point is not None and eval_point >= x[0] and eval_point <= x[-1]:
            ...
            ax1.annotate(
                f"Quadratic: {y_quadratic_eval:.2f}",
        ...
        if show_derivatives:
            ...
            if eval_point is not None and eval_point >= x[0] and eval_point <= x[-1]:
                ...
                ax2.annotate(
                    f"Linear derivative: {deriv_linear_eval:.2f}",
                ...
                ax2.annotate(
                    f"Quadratic derivative: {deriv_quadratic_eval:.2f}",
